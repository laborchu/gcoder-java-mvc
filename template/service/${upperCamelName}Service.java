...
public class ${table.upperCamelName}Service {
    ...
    public void create(${table.upperCamelName}VO ${table.lowerCamelName}VO) {
        this.daoRouter.insert("A${table.upperCamelName}.insert${table.upperCamelName}", ${table.lowerCamelName}VO);
    }
    ...
    public void update(${table.upperCamelName}VO ${table.lowerCamelName}VO) {
        this.daoRouter.update("A${table.upperCamelName}.update${table.upperCamelName}", ${table.lowerCamelName}VO);
    }
